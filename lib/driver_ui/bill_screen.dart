...
class DriverBillCalculationClass extends StatefulWidget {
  DriverBillCalculationClass(String trip_id);

  @override
  _DriverBillCalculationClassState createState() =>
      _DriverBillCalculationClassState();
}

class _DriverBillCalculationClassState
    extends State<DriverBillCalculationClass> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                billShowBox(),
                Text(
                  'How much cash you have recieved?',
                ...
                other ? otherInputField() : SizedBox(),
                paymentButtons(),
              ],
            ),
          ),
              ...
              children: [
                ...
                displayDetails == 1
                    ? Container(
                        ...
                        child: Text(
                          '\n\nTime: ' +
                              tripDirectionDetails.durationText.toString() +
                              '\nDistance: ' +
                              tripDirectionDetails.distanceText.toString() +
                              '\nAdditional Charges/Mint: ' +
                              additional.toString() +
                              '\nDiscount: 0',
                          overflow: TextOverflow.visible,
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text(
                  'How was the trip with ${custom_rider}?',
  ...
  void dialogeSubmitPress() {
    ...
    DatabaseReference feedbackReference = FirebaseDatabase.instance
        .reference()
        .child('rideRequest/${custom_trip_id}/feedback_to_customer');
    feedbackReference.set(feedback);

    DatabaseReference updateRefo = FirebaseDatabase.instance
        .reference()
        .child('users/${custom_rider_id}/feedback');
