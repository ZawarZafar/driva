...
class _CareRegistrationClassState extends State<CareRegistrationClass> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != selectedDate)
      setState(() {
        selectedDate = picked;
        vehicleInssuranceDateController.text = selectedDate.day.toString() +
            "-" +
  ...
  Future<void> updatePress() async {
    ...
    if (vehicleRegController.text == null || vehicleRegController.text == "") {
    ...
    } else if (vehicleModelNoController.text == null ||
        vehicleModelNoController.text == "") {
      showSnackBar('Please Enter vehicle Model No.');
    } else if (vehicleManuController.text == null ||
        vehicleManuController.text == "") {
      showSnackBar('Please Enter Manufacturar.');
    } else if (vehicleInssuranceCompanyController.text == null ||
        vehicleInssuranceCompanyController.text == "") {
      showSnackBar('Please Enter Company Name.');
    } else if (vehicleInssuranceNoController.text == null ||
        vehicleInssuranceNoController.text == "") {
      showSnackBar('Please Enter Insurance No.');
    } else if (vehicleInssuranceDateController.text == null ||
        vehicleInssuranceDateController.text == "") {
      ...
      DatabaseReference databaseReference = FirebaseDatabase.instance
          .reference()
          .child('users/${user.uid}/vehicle/');
      DatabaseReference databaseImage = FirebaseDatabase.instance
          .reference()
          .child('users/${user.uid}/vehicleImage');
