                              ...
                              if (formKey.currentState.validate()) {
                                ...
                                DatabaseReference databaseReference =
                                    FirebaseDatabase.instance
                                        .reference()
                                        .child(
                                            'users/${currentUserInfo.id}/paymentCards/')
                                        .push();
...
//Info available below the appbar
      ...
      child: Column(
        ...
        children: [
          Text(
            'Available balance',
            style: TextStyle(
                color: DarkGray, fontSize: 16, fontWeight: FontWeight.bold),
          ),
          SizedBox(
            height: 10,
          ),
                                    ...
                                    onPressed: () {
                                      DatabaseReference databaseReference =
                                          FirebaseDatabase.instance
                                              .reference()
                                              .child(
                                                  'users/${currentUserInfo.id}/paymentCards/${list[index]["cardID"]}');
  ...
  Widget cardNOInput(
    ...
    return Container(
      ...
      height: 25,
      decoration: BoxDecoration(border: Border.all(width: 2, color: lightGray)),
      child: TextFormField(
        decoration: InputDecoration(
          ...
          hintText: hint,
          hintStyle: TextStyle(
              color: lightGray, fontSize: 15, fontWeight: FontWeight.bold),
        ),
  ...
  Widget cardType() {
    return Container(
      ...
      child: DropdownButton(
          style: TextStyle(
              fontWeight: FontWeight.w500, color: lightGray, fontSize: 15),
          elevation: 15,
          isExpanded: false,
          icon: Container(),
          value: _value,
          items: [
            ...
            DropdownMenuItem(child: Text("Visa Card"), value: 3),
          ],
          onChanged: (value) {
            setState(() {
              _value = value;
